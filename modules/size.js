...
function renderSizeCanvas() {
  ...
  // Tylko jeśli wymiary się zmieniły, aktualizujemy style
  if (sizeCanvas.style.width !== displayW + 'px' || sizeCanvas.style.height !== displayH + 'px') {
    sizeCanvas.style.width = displayW + 'px';
    sizeCanvas.style.height = displayH + 'px';
  }
  
  // Wymiary canvas (bitmap) - zawsze przeliczane
